...
VALUES ("Hanei", "Islim"),("Abood","Islim"),("Roa","Masri"),("Fofo","Dan"),("Sabri","Yaish");
...
LEFT JOIN users as users2 ON users2.id = friendshiphs.friend_id;
...
SELECT COUNT(*) as number_of_friendships FROM frienships;
